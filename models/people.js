...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ TAG???
  var query = [
    ...
    'WITH DISTINCT { name: tags.name, poster_img: tags.poster_img } as related, count(DISTINCT gists) as weight, gist, tag',
    'ORDER BY weight DESC',
    'RETURN collect(DISTINCT { title: gist.title, poster_img: gist.poster_img }) as gist, collect(DISTINCT { related: related, weight: weight }) as related, tag as person'
  ].join('\n');
