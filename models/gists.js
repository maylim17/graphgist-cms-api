...
var _getGistByTitle = function (params, options, callback) {
  ...
  var query = [
    ...
    // 'WITH gist, collect({name: actor.name, poster_img: actor.poster_img, weight: actorgistsweight}) as actors', 
    ...
    'WITH collect(DISTINCT { related: { title: related.title, poster_img: related.poster_img }, weight: keywords }) as related, gist, domains, usecases, writers',
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ gist name?
  var query = [
    'MERGE (gist:Gist {title: {name}, id: {id}})',
    'ON CREATE',
